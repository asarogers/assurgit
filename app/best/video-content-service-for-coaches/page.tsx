...
export const metadata: Metadata = {
  ...
  openGraph: {
    url: "https://assurgit.com/best/video-content-service-for-coaches",
  ...
  alternates: {
    canonical: 'https://assurgit.com/best/video-content-service-for-coaches',
  },
};
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "Video Content Service For Coaches",
      "item": "https://assurgit.com/best/video-content-service-for-coaches"
    }
  ]
};
