...
var BuildId = "Dng9Wq2JCqnGZM-YRTa2h";
...
var ConfigHeaders = [{ "source": "/uploads/:path*", "headers": [{ "key": "Cache-Control", "value": "public, max-age=31536000" }], "regex": "^/uploads(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))?(?:/)?$" }, { "source": "/(.*)", "headers": [{ "key": "Last-Modified", "value": "Thu, 23 Apr 2026 04:50:00 GMT" }, { "key": "Vary", "value": "Accept-Encoding" }], "regex": "^(?:/(.*))(?:/)?$" }];
