const deliverables = [
  {
    ...
    title: "5 Branded Videos",
    description: "Shot in your avatar, voiced in your clone — every single week without exception.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: "Written from competitive intel and trending topics in your niche — not generic AI slop.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: "Every video is reviewed by a human before it goes live — quality, captions, branding, format.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
